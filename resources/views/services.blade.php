...
@section('content')
  ...
  <section class="section-padding pattern-overlay-7">
    <div class="container">
      <div class="row d-flex justify-content-lg-between">
        <div class="col-12">
          <h1 class="display-4 pt-5 text-dark-stroke text-center text-primary-shadow">Our Services</h1>
        </div>
      </div>
    </div>
  </section>
  ...
  <!-- Hero -->
  <section class="section-padding bg-white pattern-overlay-3 pt-0 position-relative h-400 h-md-600 h-lg-700 h-xl-800">
    <div class="container position-relative">
      ...
      <div class="row">
        <div class="col-lg-8 position-absolute start-0 top-0 text-start mt-5 mt-md-9">
          <h1 class="display-4 text-dark"><span class="text-dark-stroke text-primary-shadow">This is how we
              roll</span> your business online</h1>
          <a href="contact.html" class="btn btn-dark btn-line">Talk to an expert</a>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="row bg-light rounded p-4 p-xl-6 d-flex justify-content-lg-between">
        ...
        <div class="col-md-4 col-lg-3">
          <ul class="list-group list-group-borderless list-group-icon-primary-bg">
            ...
            <li class="list-group-item"><i class="fas fa-check"></i>Get peace of mind knowing your services are in
              trusted hands</li>
            <li class="list-group-item"><i class="fas fa-check"></i>Reduce your service costs</li>
            <li class="list-group-item"><i class="fas fa-check"></i>Secure their enterprise platform for today and the
              future</li>
          </ul>
        </div>
        <div class="col-md-4 col-lg-3">
  ...
  <!-- Services -->
  <section class="section-padding position-relative pb-0">
  ...
  <!-- Steps -->
  <section class="section-padding bg-dark rounded mx-xxxl-9">
    <div class="container">
      <div class="row">
        <div class="col-sm-12 col-md-4 mb-5">
          <div class="text-start position-relative">
            <h2 class="display-4 mb-0 text-light-stroke opacity-2">01</h2>
            <h4 class="text-white position-absolute start-0 top-0 mt-0 mt-sm-3 ps-6 d-block">Research and <br>
              analytics</h4>
          </div>
          <div class="ps-6">
            <p>We start with Research also to image Seas Void Great day sea don't creature land you're morning doesn't
            </p>
        ...
        <div class="col-sm-6 col-md-4 mb-5">
          <div class="text-start position-relative">
            ...
            <h4 class="text-white position-absolute start-0 top-0 mt-0 mt-sm-3 ps-6 d-block">Design and <br> Develop
            </h4>
          </div>
          <div class="ps-6">
            <p>In this step our Them Subdue you life created day given light gathering Days very air Fruitful form he
              him </p>
        ...
        <div class="col-sm-6 col-md-4">
          <div class="text-start position-relative">
            ...
            <h4 class="text-white position-absolute start-0 top-0 mt-0 mt-sm-3 ps-6 d-block">Testing and <br> Launch
            </h4>
          </div>
          <div class="ps-6">
            <p>Final step of success firmament of also it great have set behold land third he great years midst stars
              green</p>
            <img class="rounded" src="assets/images/about/03.jpg" alt="">
          </div>
        </div>
